...
export const experience = [
  {
    ...
    summary:
      "Translating customer requirements into structured industrial fencing layouts, quotations and materials lists.",
    highlights: [
    ...
    tech: ["CET Material Handling", "Troax Extension", "Incoterms"],
  },
  {
    company: "Supercheap Auto",
    role: "Retail Sales Associate",
    start: "Oct 2021",
    end: "Nov 2024",
    summary:
      "Diagnosed customer needs and translated technical automotive information into clear, practical guidance.",
    highlights: [
